...
public class WechatLoginService {
  ...
  private String app() {
    return WechatGateway.env("PAW_WECHAT_APP_ID");
  }
  ...
  public Map<String, Object> authorize(
    ...
    String callback = WechatGateway.env("PAW_WECHAT_OAUTH_REDIRECT");
    require(
  ...
  public Map<String, Object> login(
    ...
    String secret = WechatGateway.env("PAW_WECHAT_APP_SECRET");
