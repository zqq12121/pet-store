...
def main():
    ...
    for key in ("DEEPSEEK_API_KEY", "PAW_SMS_SIGN_NAME", "PAW_SMS_CONFIRM_TEMPLATE", "PAW_SMS_APPOINTMENT_SUBMITTED_TEMPLATE", "PAW_SMS_APPOINTMENT_CONFIRMED_TEMPLATE", "PAW_SMS_APPOINTMENT_CANCELLED_TEMPLATE", "PAW_SMS_APPOINTMENT_EXPIRED_TEMPLATE"):
